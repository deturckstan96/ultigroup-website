    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: "Al geleverd",       waarde: totaalVerbruikt, kleur: "text-[#0C355F]",   bg: "bg-[#0C355F]/6" },
      ...
      <div className="space-y-3">
        {ioNummers.map((io) => {
          ...
          const barKleur = leeg ? "bg-[#1F2328]/20" : bijna ? "bg-amber-500" : "bg-[#0C355F]";
          ...
          return (
            <div
              ...
              className={`bg-white border rounded-xl overflow-hidden transition-all ${
                isOpen ? "border-[#0C355F]/30" : "border-[#1F2328]/10"
              }`}
            >
              {/* Header rij */}
              <button
              ...
              >
                ...
                <div className="shrink-0">
                  ...
                  <p className="text-sm font-medium text-[#1F2328]">
                    <span className="font-bold text-[#0C355F] font-mono mr-1.5">{io.item_id}</span>
                    {io.item_name ?? ""}
                  </p>
                </div>
                          ...
                          {io.leveringen.map((lev) => {
                            ...
                            return (
                              <tr key={lev.delivery_id} className="border-b border-[#1F2328]/5 hover:bg-[#F5F7FA]">
                                ...
                                <td className="py-2.5 pr-6 text-[#0C355F] font-mono text-xs font-semibold">
